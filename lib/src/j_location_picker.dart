...
import 'package:j_location_picker/src/map.dart';
import 'package:j_location_picker/src/search_input.dart';
...
import 'package:j_location_picker/src/rich_suggestion.dart';
import 'package:j_location_picker/src/utils/uuid.dart';
    ...
    return MultiProvider(
      ...
      child: Builder(builder: (context) {
        return Scaffold(
          ...
          body: MapPicker(
            widget.apiKey,
            fetchAddress: widget.fetchAddress,
